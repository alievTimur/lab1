...
function calculateCarValue(form) {
	...
	if(carAge < 5){
		window.alert("It's too new if it's " + carAge + " years old.");
		return;
	}
	 
	window.alert('I would be happy to take this rust bucket car off your hands. We would be happy to offer you \u00a3' + Math.round(value) + " for your lovely car!");
}
